...
class _$AuthTokenImpl with DiagnosticableTreeMixin implements _AuthToken {
  const _$AuthTokenImpl({required this.status, this.message, this.data});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AuthToken(status: $status, message: $message, data: $data)';
  }
...
abstract class _AuthToken implements AuthToken {
  const factory _AuthToken(
      ...
      final String? message,
      final AuthData? data}) = _$AuthTokenImpl;
...
abstract class $AuthDataCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'auth_token') int authToken});
}
...
class _$AuthDataImpl with DiagnosticableTreeMixin implements _AuthData {
  const _$AuthDataImpl({@JsonKey(name: 'auth_token') required this.authToken});
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AuthData(authToken: $authToken)';
  }
...
abstract class _AuthData implements AuthData {
  const factory _AuthData(
          {@JsonKey(name: 'auth_token') required final int authToken}) =
      _$AuthDataImpl;
